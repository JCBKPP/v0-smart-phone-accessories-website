...
export default function FindUsPage() {
  ...
  return (
    <>
      ...
      <section className="sticky top-[57px] z-40 border-b border-border/20 bg-background/80 backdrop-blur-xl">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-2.5">
          {/* Top row: Search + area pills in a single compact strip */}
          <div className="flex items-center gap-2">
            ...
            <div className="relative shrink-0 w-36 sm:w-44">
              ...
              <input
                ...
                className="w-full rounded-full border border-border/40 bg-secondary/50 pl-8 pr-7 py-1.5 text-xs text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-1 focus:ring-primary/30 focus:border-primary/30 transition-all"
              />
              {search && (
                <button
                  type="button"
